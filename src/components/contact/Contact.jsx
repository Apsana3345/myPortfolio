...
<div className="text">
<p className="para-First">Let's Connect  </p>
<span className="nameContactIntro">
You can send me message from here</span>
</div>
...
<div className="form">
   ...
   <form  action="https://getform.io/f/bzyyxnma" method="post" className="inputValue" >
     <input type="text" placeholder="Name" id="name" name="name"/>
     <input type="email" placeholder="Email" id="email" name="email"/>
<textarea type="text" placeholder='Your Message' id="textarea" cols={40} rows={5} name="message"></textarea>
<button  className="btn-form" value="submit">Send</button>
   </form>
